...
# Code Editor
# VERSION: 0.0.1
# BUILT ON: 2014-09-10T04:46:10.680Z
# CONFIGURATION:
...
?>body{font-family:sans-serif;font-size:11px;margin:0}a{text-decoration:none}input[type=text]{border:1px solid #444}header nav a{float:left;padding:6px 7px;color:#444}header nav a:hover{background-color:#aaa}header nav:after{content:"";clear:both;display:table}header nav .active{font-weight:700}form{display:none;border-top:1px solid #444;padding:10px}form .fieldRow{margin-bottom:5px}pre{margin:0 0 10px}input[readonly]{background-color:#ddd;opacity:.3}#list{border-bottom:1px solid #444;font-weight:700}#list>div{width:100%;border-top:1px solid #444;display:table}#list>div>*{display:table-cell;padding:2px 0 2px 3px}#list>div>a .indent{margin-left:10px}#list>div.bad{text-decoration:line-through}#list .cut{width:16px;min-width:16px;background-size:100%;background-position:50% 50%;background-repeat:no-repeat;background-color:#fff;background-image:url(//cdnjs.cloudflare.com/ajax/libs/fatcow-icons/20130425/FatCow_Icons32x32/cut.png)}#list .copy{width:16px;min-width:16px;background-size:100%;background-position:50% 50%;background-repeat:no-repeat;background-color:#fff;background-image:url(//cdnjs.cloudflare.com/ajax/libs/fatcow-icons/20130425/FatCow_Icons32x32/page_copy.png)}#list .paste{width:16px;min-width:16px;background-size:100%;background-position:50% 50%;background-repeat:no-repeat;background-color:#fff;background-image:url(//cdnjs.cloudflare.com/ajax/libs/fatcow-icons/20130425/FatCow_Icons32x32/page_paste.png)}#list .dir .paste{display:none}#list .del,#list .remove-clip{width:16px;min-width:16px;background-size:100%;background-position:50% 50%;background-repeat:no-repeat;background-color:#fff;background-image:url(//cdnjs.cloudflare.com/ajax/libs/fatcow-icons/20130425/FatCow_Icons32x32/delete.png)}#list .del:not([onclick]){display:none}#list .direct{width:16px;min-width:16px;background-size:100%;background-position:50% 50%;background-repeat:no-repeat;background-color:#fff;background-image:url(//cdnjs.cloudflare.com/ajax/libs/fatcow-icons/20130425/FatCow_Icons32x32/world_go.png)}#list .direct[href=""]{display:none}#list .dl{width:16px;min-width:16px;background-size:100%;background-position:50% 50%;background-repeat:no-repeat;background-color:#fff;background-image:url(//cdnjs.cloudflare.com/ajax/libs/fatcow-icons/20130425/FatCow_Icons32x32/inbox_download.png)}#list>div:nth-of-type(odd){background-color:#dfd}#list>div:hover,#list>div:nth-of-type(odd):hover{background-color:#ddd}#list .seg:hover{text-decoration:underline;color:#444!important}#list .seg[href=""]:hover{text-decoration:none;color:#ccc!important}#list .dir,#list .file{cursor:pointer}#list .dir .filepath,#list .dir .seg{color:#bb0}#list .file .filepath,#list .file .seg{color:#1b0}#list .seg[href=""]{color:#ccc;cursor:default}#list .size{color:#bbb;margin-left:5px;font-size:10px;width:100px}#list .dir .size:after{content:" files"}#list .age:after{content:" old"}#list .age{color:#bbb;font-size:10px;width:100px}@media (max-width:979px){body{font-size:12px}#list>div>*{display:block;padding-bottom:0}#list .age,#list .size{float:left;height:16px;height:auto;padding:0 0 4px}#list .copy,#list .cut,#list .del,#list .direct,#list .dl,#list .paste,#list .remove-clip{float:right;height:17px;width:17px;padding:0}}button{border:none;margin:0;font-size:10px}#editor{margin-top:15px;position:absolute;top:0;bottom:0;left:0;right:0}<?php
exit;
}
if(isset($_GET['js'])){header('Content-Type: application/javascript');
header('Cache-Control: public, maxage=31536000');
?>!function(a){"use strict";var b="",c={};try{-1!==window.location.search.search(new RegExp("[?&]p=([^&$]*)","i"))&&(b=RegExp.$1),b=decodeURIComponent(b)}catch(d){alert(d),alert("Path="+b)}window.editor=c,c.detectFileMode=function(a){var b=a.substring(a.lastIndexOf(".")+1);switch(b){case"css":return"css";case"js":return"javascript";case"json":return"json";case"asax":case"cs":return"csharp";case"xml":return"xml";case"phtml":case"php":return"php";case"config":return"xml";case"as":return"actionscript";case"bat":case"cmd":return"batchfile";case"c":case"h":case"hpp":case"cpp":return"c_cpp";case"coffee":return"coffee";case"dart":return"dart";case"diff":return"diff";case"asp":case"asa":case"aspx":case"ascx":case"htm":case"html":return"html";case"ini":return"ini";case"java":return"java";case"jsp":return"jsp";case"less":return"less";case"lua":return"lua";case"pl":return"perl";case"ps":return"powershell";case"py":return"python";case"cgi":case"sh":return"sh";case"sql":return"sql";case"svg":return"svg";default:return""}},c.detectFileModeByContent=function(a){return 0===a.indexOf("#!/bin/sh")?"sh":0===a.indexOf("#!/bin/bash")?"sh":""},c.save=function(a){jQuery.ajax({url:"?",type:"post",dataType:"json",data:{content:c.instance.getValue(),p:b},success:function(){a?history.back():c.isModified&&(c.isModified=!1,document.title=document.title.substring(1))},error:function(a){alert(a.responseText)}})},c.clip={getItems:function(){var a=localStorage.clipValue;return a?JSON.parse(a):[]},setItems:function(a){localStorage.clipValue=JSON.stringify(a)},add:function(a,b){var c=this.getItems();c.push({path:a,type:b}),this.setItems(c)},remove:function(a){var b,d=a,e=c.clip.getItems();return"object"==typeof d&&(d=a.path),(b=e.filter(function(a){return a.path===d})[0])?(e.splice(e.indexOf(b),1),this.setItems(e),!0):!1}},c.del=function(b,c){var d=!1,e=a(c).parent("div");return 0===e.length&&console.error("DEBUG: Cannot find row in DOM."),a.ajax({url:"?",method:"post",data:{p:b,rm:1},async:!1,success:function(a){a.success===!0?(e.remove(),d=!0):alert(a.message)},error:function(a){alert(a.responseText)}}),d},c.cut=function(a){c.clip.add(a,"cut"),console.log("Clipboard: "+a)},c.copy=function(a){c.clip.add(a,"copy"),console.log("Clipboard: "+a)},c.paste=function(b,d){var e,f,g;b||(b=c.clip.getItems()[0].path),e=c.clip.getItems().filter(function(a){return a.path===b})[0],f=prompt("copy"===e.type?"Copy to:":"Move to:",e.path.substring(1+e.path.lastIndexOf("/"))),f&&(d+="/"+f,g={source:e.path,dest:d},"copy"===e.type?g.cp=1:"cut"===e.type&&(g.mv=1),d&&a.ajax({url:"?",method:"post",data:g,success:function(a){a.success===!0?(c.clip.remove(b),window.location=window.location):alert(a.message)},error:function(a){alert(a.responseText)}}))},c.instance=null,function(){var d,e,f;a("#editor").each(function(){a("header.list").hide(),f=c.detectFileMode(b),f||(f=c.detectFileModeByContent(document.getElementById("editor").textContent.trim())),c.instance=ace.edit("editor"),a(this).get(0).hasAttribute("data-readonly")&&c.instance.setOptions({readOnly:!0,highlightActiveLine:!1,highlightGutterLine:!1}),c.instance.on("change",function(){c.isModified||(c.isModified=!0,document.title="*"+document.title)}),f?("undefined"!=typeof console&&console.log("Setting editor mode: ace/mode/"+f),c.instance.getSession().setMode("ace/mode/"+f)):"undefined"!=typeof console&&console.log("Unsupported editor mode. All available modes here: https://github.com/ajaxorg/ace-builds/tree/master/src-noconflict"),c.instance.commands.addCommand({name:"Save",bindKey:{win:"Ctrl-s",mac:"Command-s"},exec:function(){c.save(!1)}})}),window.location.hash&&(window.location=window.location.search),d=c.clip.getItems(),e=a("#list"),d.forEach(function(d){var f=a("<a/>").text(d.path),g=a("<a/>").addClass("paste").attr("href","#"),h=a("<a/>").addClass("remove-clip").attr("href","#");e.append(a("<div/>").addClass("clip").append(f).append(g).append(h)),g.click(function(){return c.paste(d.path,b),!1}),h.click(function(){return c.clip.remove(d.path)&&a(this).parent().remove(),!1})}),d.length>0&&a("#list>div.dir>a.paste").css({display:"table-cell"})}(),a(document).keydown(function(b){115===b.keyCode&&a(".shellButton").click()}),a(function(){a(".searchForm select").change(function(){"Locate Database"===a(this).val()?a(".searchForm input[type=checkbox]").prop("checked",!1).prop("disabled",!0):a(".searchForm input[type=checkbox]").prop("disabled",!1)}),a(".searchForm button").click(function(){var c=a(".searchForm select").val(),d="?p="+encodeURI(b);a(".searchForm input[type=checkbox]").prop("checked")&&(d+="&r="),("Filenames"===c||"All"===c)&&(d+="&find="+encodeURI(a(".searchForm input[type=text]").val())),("Content (All Files)"===c||"All"===c)&&(d+="&grep="+encodeURI(a(".searchForm input[type=text]").val())),"Content (Code Only)"===c&&(d+="&find=^[^.]*$|\\.(php|js|json|..?ss|p?html?|as..?|cs|vb|rb|py|txt|md|xml|xslt?|config)$&grep="+encodeURI(a(".searchForm input[type=text]").val())),"Locate Database"===c&&(d+="&locate="+encodeURI(a(".searchForm input[type=text]").val().replace(/[ ]+/g,".*"))),window.location=d}),a(".newButton").click(function(){var c=prompt("New file (end with / for dir):","new.txt"),d="file";"/"===c.substring(c.length-1)&&(d="dir",c=c.substring(0,c.length-1)),c&&a.ajax({url:"?",method:"post",data:{"new":1,p:b+"/"+c,type:d},dataType:"json",success:function(a){a.success===!0?window.location="?p="+encodeURI(b+"/"+c):alert(a.message)},error:function(a){alert(a.responseText)}})}),a(".searchButton").click(function(){a(this).addClass("active"),a(".searchForm").show().find("input").select()}),a(".shellButton").click(function(){a(this).addClass("active");var c,d=a(".shellForm").show().find("input").select(),e=!0,f=!1,g=!0;c=function(h){"undefined"==typeof h&&(h=null),a.ajax({url:"?",type:"post",dataType:"json",data:{ajaxShell:h,p:b},success:function(b){return b.lastCmd&&d.val(b.lastCmd).prop("readonly",!0),b.idle===!0?void d.prop("readonly",!1):(e===!0&&b.first!==!0&&(f=!0,a(".shellForm input#shellFormBackground").prop("checked",!0)),e=!1,g=!g,a("#shellOutput").html((f?"Continuing last session...\n\n":"")+b.output+(b.continue===!0?g?"_":" ":"")),void(b.continue===!0?setTimeout(c,500):("failure"===b.result?(a(".shellForm").css({backgroundColor:"#f44"}),alert("Last command failed.")):"success"===b.result?a(".shellForm").css({backgroundColor:"#6f6"}):(a(".shellForm").css({backgroundColor:"#bbb"}),alert("Last command had no result.")),d.prop("readonly",!1).select())))}})},c(),a(".shellForm").submit(function(){var b=JSON.parse(localStorage.shellHistory||"[]");return b.push(d.val()),localStorage.shellHistory=JSON.stringify(b),a(".shellForm input#shellFormBackground").prop("checked")?(a(".shellForm").css({backgroundColor:"#fff"}),c(d.val()),!1):!0})}),a('#list .dir a[class!="seg"], #list .file a[class!="seg"]').click(function(a){a.stopPropagation()}),a("#list .dir, #list .file").click(function(){a(this).find("a.seg").get(0).click()});var c=function(){var b,c,d=a("#shellHistory"),e=JSON.parse(localStorage.shellHistory||"[]");for(b=0;b<e.length,c=e[b];b+=1)d.append(a("<option/>").attr("value",c))};c(),a("#list").dropzone({url:"?p="+b,clickable:!1,previewsContainer:"body",totaluploadprogress:function(a){100===a&&(window.location=window.location)}}),a(".uploadButton").dropzone({url:"?p="+b,clickable:!0,previewsContainer:"body",totaluploadprogress:function(a){100===a&&(window.location=window.location)}})})}(jQuery);<?php
exit;
}
