...
<html lang="en" class="set-password">
	<head>
		...
		$(function()
		{
			...
			{
				document.cookie = "editor-auth=" + MD5(document.forms[0].password.value) + ";path=" + window.location.pathname + ";max-age=315360000" + (document.location.protocol === "http:" ? "" : ";secure");
			});
		});
		</script>
	</head>
